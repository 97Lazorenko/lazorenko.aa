...
begin
    v_valid_ticket_stat :=sys.diutil.bool_to_int(lazorenko_al.ticket_status_check(32, 7));
...
begin
    ...
    where (r.ticket_id=p_ticket_id and r.record_stat_id=2 and (r.patient_id=p_patient_id or r.patient_id<>p_patient_id))
          or (r.ticket_id=p_ticket_id and r.record_stat_id in (1, 3) and r.patient_id<>p_patient_id)
...
begin
    v_valid_ticket :=sys.diutil.bool_to_int(lazorenko_al.ticket_check(33, 7));
...
create or replace function lazorenko_al.check_IN_parameters(
